...
add-highlighter shared/ regions -default code gdscript \
    docstring     '"""' '"""'            '' \
    docstring     "'''" "'''"            '' \
    double_string '"'   (?<!\\)(\\\\)*"  '' \
    single_string "'"   (?<!\\)(\\\\)*'  '' \
...
# Integer formats
add-highlighter shared/gdscript/code regex '(?i)\b0x[\da-f]+\b' 0:value
add-highlighter shared/gdscript/code regex '(?i)\b([1-9]\d*|0)\b' 0:value
# Float formats
...
# Imaginary formats
add-highlighter shared/gdscript/code regex '\b\d+\+\d+[jJ]\b' 0:value

add-highlighter shared/gdscript/double_string fill string
add-highlighter shared/gdscript/single_string fill string

add-highlighter shared/gdscript/docstring/ regions -default docstring gd-docstring \
    gdscript '>>> \K'    '\z' '' \
    gdscript '\.\.\. \K' '\z' ''
add-highlighter shared/gdscript/docstring/gd-docstring/gdscript ref gdscript
add-highlighter shared/gdscript/docstring/gd-docstring/docstring fill string

add-highlighter shared/gdscript/comment       fill comment

%sh{
    # Grammar
    values="true|false|self|inf"
    # meta="import|from"
    ...
    keywords="and|assert|break|class|continue|func|elif|else"
    keywords="${keywords}|for|if|in|not|or|pass|print"
    keywords="${keywords}|return|while|yield"
