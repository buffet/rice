...
#+BEGIN_SRC emacs-lisp
  (use-package base16-theme
    :ensure nil
    :load-path "/etc/nixos/extraConf/emacs/base16-emacs"
    :init
    (add-to-list 'custom-theme-load-path "/etc/nixos/extraConf/emacs/base16-emacs/build")
    :config
    (load-theme 'base16-latte t))
#+END_SRC
